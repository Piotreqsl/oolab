...
public class RectangularMapTest {
    ...
    public void placeTest() {
        ...
        Assertions.assertFalse(map.place(new Animal(map, new Vector2d(1, 1))), "cant place again");

        Assertions.assertFalse(map.place(new Animal(map, new Vector2d(3, 1))), "Cant place outside borders");
